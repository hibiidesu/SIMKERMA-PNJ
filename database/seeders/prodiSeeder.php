...
class prodiSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ['name' => 'D1 - Bahasa Inggris untuk Komunikasi Bisnis dan Profesional S1 Terapan', 'unit_id' => 15],
            ['name' => 'D1 - Teknik Komputer dan Jaringan', 'unit_id' => 4],
            ['name' => 'D1 - Teknik Mesin', 'unit_id' => 5],
            ['name' => 'D2 - Alat Berat, Kampus di Pusat Pengembangan dan Pelatihan PTK', 'unit_id' => 5],
            ['name' => 'D2 - Teknik Grafika Kab. Demak', 'unit_id' => 8],
            ['name' => 'D2 - Teknik Grafika Kota Pekalongan', 'unit_id' => 8],
            ['name' => 'D2 - Teknik Konversi Energi, Kampus di Pusat Pengembangan & Pelatihan PTK', 'unit_id' => 5],
            ['name' => 'D2 - Teknik Manufaktur Mesin', 'unit_id' => 5],
            ['name' => 'D2 - Teknik Mesin K. Kota Pekalongan', 'unit_id' => 5],
            ['name' => 'D2 - Teknik Mesin Kab. Demak', 'unit_id' => 5],
            ['name' => 'D2 - Usaha Jasa Konvensi, Perjalanan Insentif dan Pameran K. Demak', 'unit_id' => 7],
            ...
            ['name' => 'D3 - Manajemen Pemasaran Untuk Warga Negara Berkebutuhan Khusus', 'unit_id' => 6],
            ...
            ['name' => 'D4 - Bahasa Inggris untuk Komunikasi Bisnis dan Profesional', 'unit_id' => 15],
            ['name' => 'D4 - BroadBand Multimedia', 'unit_id' => 10],
            ['name' => 'D4 - Desain Grafis', 'unit_id' => 8],
            ['name' => 'D4 - Instrumentasi Dan Kontrol Industri', 'unit_id' => 10],
            ['name' => 'D4 - Keuangan dan Perbankan', 'unit_id' => 6],
            ['name' => 'D4 - Keuangan Dan Perbankan Syari ah', 'unit_id' => 6],
            ...
            ['name' => 'D4 - Teknik KontrukSi Gedung', 'unit_id' => 9],
            ['name' => 'D4 - Teknik Mesin (Kampus Kab. Demak)', 'unit_id' => 5],
            ...
            ['name' => 'D4 - Teknologi Rekayasa Pemeliharaan Alat Berat', 'unit_id' => 5],
            ['name' => 'D4 - Usaha Jasa Konvensi, Perjalanan Insentif dan Pameran', 'unit_id' => 7],
            ['name' => 'D4 - Usaha Jasa Konvensi, Perjalanan Insentif, dan Pameran (Kampus Kab. Demak)', 'unit_id' => 7],
            ['name' => 'S2 Terapan - Rekayasa Teknologi Manufaktur', 'unit_id' => 5],
            ['name' => 'S2 Terapan - Teknik Elektro', 'unit_id' => 10],
            ['name' => 'S3 - Test', 'unit_id' => 5],
        ];
        prodi::truncate();
