        ...
        <div class="card">
            <div class="card-header">
                ...
                @if (Auth::user()->role->role_name == 'admin')
                    <a href="{{ url('/admin/pengajuan-kerjasama/record') }}" class="btn btn-custom"><i class="fas fa-clipboard"></i> &nbsp;Tambah Baru Record</a>
                    <a href="{{ url('/admin/pengajuan-kerjasama/add') }}" class="btn btn-success"><i class="fas fa-plus"></i> &nbsp;Tambah Baru Request</a>
                @elseif (Auth::user()->role->role_name == 'pic')
                    <a href="{{ url('/pic/pengajuan-kerjasama/add') }}" class="btn btn-info"><i class="fas fa-plus"></i> &nbsp;Tambah Baru</a>
                @endif
            </div>
            <div class="card-body">
