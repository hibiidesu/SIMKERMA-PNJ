                                ...
                                <div class="col-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_surat" class="form-control" name="nama_surat"
                                            value="{{ old('nama_surat', $template->nama_surat) }}" required autofocus>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            <label class="mb-2 fw-bold text-capitalize" for="template_surat">Update surat:
                                    ...
                                    @if ($template->template_surat)
                                        <div class="col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <embed src="{{ asset('/template_surat/' . $template->template_surat) }}"
