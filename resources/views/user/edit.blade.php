                ...
                <div class="card-body">
                    ...
                    @if (Request::segment(2) == 'my-profile')
                        <form id="kForm" class="form form-vertical" method="post"
                            action="{{ url('/' . Request::segment(1) . '/my-profile/update') }}">
                        @else
                            <form id="kForm" class="form form-vertical" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <small id="emailHelp" class="form-text text-muted">Abaikan jika tidak ingin mengubah
                                        password</small>
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    <label class="mb-2 fw-bold text-capitalize" for="re_password">Masukan Ulang
                                        Password</label>
